...
export const WithoutFavorites = () => {
  return (
    <div className="w-full h-[80vh] md:h-[90vh] flex flex-col justify-center items-center gap-6">
      ...
      <Link href={'/'} className="w-40 h-10 flex justify-center items-center dark:bg-[#1A1C29] border-[#1a1c29] bg-white dark:border-white border-[1px] rounded-lg transition duration-200 hover:scale-105">
        Go ahead
      </Link>
    </div>
  )
